...
cd ..
cd libsvm-3.21
#for i in {1..5}; do ./svm-train -c 8.0 -g 0.0001220703125 ../ans_SVM_train_$i.txt ; done
...
./svm-train -c 8 -g 8 ../ans_SVM_train_1.txt
./svm-train -c 32 -g 8 ../ans_SVM_train_2.txt
./svm-train -c 8 -g 8 ../ans_SVM_train_3.txt
./svm-train -c 2048 -g 2 ../ans_SVM_train_4.txt
