...
public class Solution {
    public static void main(String[] args) throws IOException
    {
    	 ...
    	 if (head.charAt(head.indexOf(":")+1)=='T') emptyLine = true;
    	 ...
    	 while (true)
    	 {
    		 ...
    		 while (now.length()==0||now.charAt(0)!=']')
    		 {
    			 ...
    			 String tmp = "";
    			 int l = 0;
    			 while (l<len&&(now.charAt(l)==' '||now.charAt(l)=='\t')) l++;
    			 int r = len-1;
    			 while (r>=0 &&(now.charAt(r)==' '||now.charAt(r)=='\t')) r--;
    	 ...
    	 FileWriter fileWriter = new FileWriter("msc.txt");  
    	 fileWriter.write(result.size()+"\n"); 
    	 //System.out.println(result.size());
    	 fileWriter.write(result.size()-preNodeNum+"\n"); 
    	 //System.out.println(result.size()-preNodeNum);
    	 fileWriter.write((nowspace-prespace)+"\n");
    	 //System.out.println(nowspace-prespace);
    	 fileWriter.write(nowspace+"\n");
