...
cd ..
cd libsvm-3.21
#for i in {1..5}; do ./svm-train -c 0.5 -g 0.5 ../ans_SVM_train_$i.txt ; done
...
./svm-train -c 8192 -g 0.0078125 ../ans_SVM_train_1.txt
./svm-train -c 0.5 -g 8 ../ans_SVM_train_2.txt
./svm-train -c 8 -g 2 ../ans_SVM_train_3.txt
./svm-train -c 512 -g 0.03 ../ans_SVM_train_4.txt
./svm-train -c 0.5 -g 8 ../ans_SVM_train_5.txt
